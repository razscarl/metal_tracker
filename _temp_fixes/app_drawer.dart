          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildMenuItem(context, Icons.home, 'Home', const HomeScreen()),
                _buildMenuItem(context, Icons.inventory_2, 'Holdings', const HoldingsScreen()),
                _buildMenuItem(context, Icons.category, 'Product Profiles', const ProductProfilesScreen()),
                _buildSectionHeader('MARKET DATA'),
                _buildMenuItem(context, Icons.price_change, 'Live Prices', const LivePricesScreen()),
                _buildMenuItem(context, Icons.show_chart, 'Spot Prices', const SpotPricesScreen()),
                _buildMenuItem(context, Icons.shopping_cart, 'Listings', const ProductListingsScreen()),
                _buildSectionHeader('MANAGEMENT'),
                _buildMenuItem(context, Icons.store, 'Retailers & Providers', const RetailersScreen()),
                _buildMenuItem(context, Icons.pie_chart, 'Analytics', const AnalyticsScreen()),
                if (isAdminUser)
                  _buildMenuItem(context, Icons.admin_panel_settings, 'Admin', const AdminDashboardScreen()),
                const Divider(color: Colors.white10),
                _buildMenuItem(context, Icons.settings, 'Settings', const SettingsScreen()),
                ListTile(
